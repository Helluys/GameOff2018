...
public class PlayerMovement {
    ...
    [SerializeField] private PlayerStatistics sharedStatistics;
    ...
    public void OnUpdate () {
        ...
        this.rigidbody.AddForce(this.sharedStatistics.acceleration * inputDirection, ForceMode.Acceleration);
        ...
        if (inputDirection.magnitude > MIN_MOVEMENT_THRESHOLD) {
            ...
            this.rigidbody.AddTorque(Vector3.up * deltaAngle * this.sharedStatistics.angularAcceleration);
        }
    }
